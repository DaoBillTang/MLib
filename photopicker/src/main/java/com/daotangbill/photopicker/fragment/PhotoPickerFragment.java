package com.daotangbill.photopicker.fragment;
...
import com.daotangbill.photopicker.PhotoPickerActivity;
import com.daotangbill.photopicker.R;
import com.daotangbill.photopicker.adapter.PhotoGridAdapter;
import com.daotangbill.photopicker.adapter.PopupDirectoryListAdapter;
import com.daotangbill.photopicker.entity.Photo;
import com.daotangbill.photopicker.entity.PhotoDirectory;
import com.daotangbill.photopicker.event.OnPhotoClickListener;
import com.daotangbill.photopicker.utils.AndroidLifecycleUtils;
import com.daotangbill.photopicker.utils.ImageCaptureManager;
import com.daotangbill.photopicker.utils.MediaStoreHelper;
import com.daotangbill.photopicker.utils.PermissionsConstant;
import com.daotangbill.photopicker.utils.PermissionsUtils;

import static android.app.Activity.RESULT_OK;
import static com.daotangbill.photopicker.PhotoPicker.DEFAULT_COLUMN_NUMBER;
import static com.daotangbill.photopicker.PhotoPicker.EXTRA_PREVIEW_ENABLED;
import static com.daotangbill.photopicker.PhotoPicker.EXTRA_SHOW_GIF;
import static com.daotangbill.photopicker.utils.MediaStoreHelper.INDEX_ALL_PHOTOS;
...
public class PhotoPickerFragment extends Fragment {
  ...
  public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
    if (grantResults.length > 0
      ...
      switch (requestCode) {
        case PermissionsConstant.INSTANCE.getREQUEST_CAMERA():
        case PermissionsConstant.INSTANCE.getREQUEST_EXTERNAL_WRITE():
