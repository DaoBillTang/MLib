...
public class PhotoPicker {
    ...
    public static class PhotoPickerBuilder {
         ...
         *                    需要实现接口：#link{onPermissionsGranted}
         * @param requestCode requestCode for result
         */
        public void start(@NonNull Activity activity, int requestCode) {
//            if (PermissionsToolsKt.toRequestPermissions(activity,
//                    PermissionsConstant.getPERMISSIONS_EXTERNAL_READ(),
...
//            if (PermissionsToolsKt.toRequestPermissions(fragment.getActivity(),
//                    PermissionsConstant.getPERMISSIONS_EXTERNAL_READ(),
//                    PermissionsConstant.REQUEST_EXTERNAL_READ)) {
//                fragment.getActivity().startActivityForResult(getIntent(context), requestCode);
//            }
