...
public class Regular {
	...
	public static final String REGEX_PHONE = "^$|^1\\d{10}$|^(\\d{3,5})-(\\d{6,9})(-(\\d{1,5}))?$";
	/** 座机 用 正则表达式(首位为1,共11位数字) */
	public static final String REGEX_TEL = "^$|^((\\d{1,3})-)?(\\d{6,9})(-(\\d{1,5}))?$";
	...
	/** 两位以内正整数或0 */
	public static final String REGEX_PINT2 = "^$|^[1-9]\\d{0,1}$|^0$";
	/** 三位以内正整数 */
	public static final String REGEX_PINT3 = "^$|^[1-9]\\d{0,2}$";
	/** 五位以内正整数 */
	public static final String REGEX_PINT5 = "^$|^[1-9]\\d{0,4}$";
	/** 五位以内正整数 */
	public static final String REGEX_PINT6 = "^$|^[1-9]\\d{0,5}$";
	/** 九位以内正整数 */
	public static final String REGEX_PINT9 = "^$|^[1-9]\\d{0,8}$";
	/** 十位以内正整或0 */
	...
	/** 车牌号 */
	public static final String REGEX_LPN = "^$|^[\u4e00-\u9fa5]{1}[a-zA-Z]{1}[a-zA-Z0-9]{5}$";
	/** 车架号 */
	public static final String REGEX_VIN = "^$|^[a-zA-Z0-9]{17}$";
	/** 车主姓名 */
	public static final String REGEX_OWNERNAME = "^$|^[\u4E00-\u9FA5A-Za-z0-9]{0,50}$";
}