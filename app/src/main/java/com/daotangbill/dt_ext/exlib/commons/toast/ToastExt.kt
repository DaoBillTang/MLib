...
class ToastExt {
    ...
    fun Context.Tnormal(message: CharSequence, duration: Int,
            ...
            custom(this, message, icon, NORMAL_COLOR, duration, withIcon, true)
    ...
    fun Context.Tinfo(
            ...
            INFO_COLOR, duration, withIcon, true)?.show()
    ...
    fun Context.Tsuccess(
            ...
            SUCCESS_COLOR, duration, withIcon, true)?.show()
    ...
    fun Context.Terror(
            ...
            ERROR_COLOR, duration, withIcon, true)?.show()
    ...
    class Config private constructor() {
        ...
        companion object {
            ...
            fun reset() {
                ...
                ToastExt.currentTypeface = LOADED_TOAST_TYPEFACE
