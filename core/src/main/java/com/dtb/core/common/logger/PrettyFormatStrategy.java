package com.dtb.core.common.logger;

import com.dtb.core.common.basetype.StringExtend;
...
public class PrettyFormatStrategy {
    ...
    private String formatTag(String tag) {
        if (!StringExtend.isEmpty(tag) && !StringExtend.equals(this.tag, tag)) {
            return this.tag + "-" + tag;
        }
        return this.tag;
    }
    ...
    public static class Builder {
        ...
        public Builder logStrategy(LogcatLogStrategy val) {
            logStrategy = val;
            return this;
        }
